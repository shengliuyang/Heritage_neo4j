...
class HeritageGraph:
        ...
        with open(self.data_path, 'r', encoding='utf-8') as f:
            ...
            for data in data_list:
                self.process_heritage_data(
                    ...
                    rels_link, rels_category_criteria
                )
    ...
    def process_heritage_data(self, data, heritage_sites, categories, criteria_set, dynasty_set,
                              ...
                              rels_dynasty, rels_culture, rels_link, rels_category_criteria):
        heritage_dict = {}
        name = data.get('Name', '')
        ...
        if criteria:
            ...
            if category:
                for criterion in criteria_items:
                    rels_category_criteria.append([category, criterion])
    ...
    def create_graphnodes(self):
        ...
        (heritage_sites, categories, criteria_set, dynasty_set, cultures, links_set, heritage_infos,
         rels_category, rels_criteria, rels_dynasty, rels_culture, rels_link, rels_category_criteria) = data
    ...
    def create_graphrels(self):
        ...
        self.create_relationship('Category', 'Criteria', rels_category_criteria, "INCLUDES_CRITERIA",
                                 "Category Criteria")
